        ...
        <div className="dis-none panel-filter w-full p-t-10">
          <div className="wrap-filter flex-w bg6 w-full p-lr-40 p-t-27 p-lr-15-sm">
            ...
            <div className="filter-col3 p-r-15 p-b-27">
              ...
              <ul>
                <li className="p-b-6">
                  <span className="fs-15 lh-12 m-r-6 text-black">
                ...
                <li className="p-b-6">
                  <span className="fs-15 lh-12 m-r-6 text-blue">
                    <i className="zmdi zmdi-circle"></i>
                  </span>
                ...
                <li className="p-b-6">
                  <span className="fs-15 lh-12 m-r-6 text-gray">
                    <i className="zmdi zmdi-circle"></i>
                  </span>
                ...
                <li className="p-b-6">
                  <span className="fs-15 lh-12 m-r-6 text-green">
                    <i className="zmdi zmdi-circle"></i>
                  </span>
                ...
                <li className="p-b-6">
                  <span className="fs-15 lh-12 m-r-6 text-red">
                    <i className="zmdi zmdi-circle"></i>
                  </span>
                ...
                <li className="p-b-6">
                  <span className="fs-15 lh-12 m-r-6 text-lightgray">
...
export default HomeSearchCondition