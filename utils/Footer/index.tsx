      ...
      <div className="container">
        <div className="row">
          ...
          <div className="col-sm-6 col-lg-3 p-b-50">
            ...
            <p className="stext-107 cl7 size-201">
              Any questions? Let us know in store at Ha Noi,
              Viet Nam, NY 10000 or call us on (+84) 332164630
            </p>
        ...
        <div className="p-t-40">
          ...
          <p className="stext-107 cl6 txt-center">
            ...
            Copyright By <Link href="https://www.facebook.com/nghia.nguyen.272">Mean Nguyen</Link> & distributed by <Link href="https://themewagon.com/">ThemeWagon</Link>
          </p>
        </div>
      </div>
    </footer>
