      ...
      <div className="tab01">
        ...
        <ul className="nav nav-tabs" role="tablist">
          <li className="nav-item p-b-10">
            <a className={`nav-link ${step === 1 ? 'active' : ''}`} data-toggle="tab" href="#!" role="tab" onClick={() => setStep(1)}>Description</a>
          </li>

          <li className="nav-item p-b-10">
            <a className={`nav-link ${step === 2 ? 'active' : ''}`} data-toggle="tab" href="#!" role="tab" onClick={() => setStep(2)}>Additional information</a>
          </li>

          <li className="nav-item p-b-10">
            <a className={`nav-link ${step === 3 ? 'active' : ''}`} data-toggle="tab" href="#!" role="tab" onClick={() => setStep(3)}>Reviews (1)</a>
          </li>
        </ul>
        ...
        <div className="tab-content p-t-43">
          ...
          {
            step === 1 &&
            <div className={`tab-pane fade ${step === 1 ? 'show active animate__animated animate__fadeIn' :''}`} id="description" role="tabpanel">
          ...
          {
            step === 2 &&
            <div className={`tab-pane fade ${step === 2? 'show active animate__animated animate__fadeIn' :''}`} id="information" role="tabpanel">
              <div className="row">
          ...
          {
            step === 3 &&
            <div className={`tab-pane fade ${step === 3 ? 'show active animate__animated animate__fadeIn animate-delay-2s' :''}`} id="reviews" role="tabpanel">
              <div className="row">
                <div className="col-sm-10 col-md-8 col-lg-6 m-lr-auto">
